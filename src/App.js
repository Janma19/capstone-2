...
function App() {
    ...
    */
    return (
        <SessionProvider value={{ user, setUser, unsetUser, productsData, setProductsData, cart, setCart, loading, setLoading, disableButtons, setDisableButtons, orderHistory, setOrderHistory }}>
            <Router>
                <AppNavbar />
